...
attraction2 = Attraction.create(name: "Smithsonian National Zoological Park", description: "Founded in 1889, its mission is to provide engaging experiences with animals and create and share knowledge to save wildlife and habitats", image: "https://www.si.edu/sites/default/files/newsdesk/building/nzp.jpg", location: "Washington DC", price: 4.99, category_id: cat1.id )
attraction3 = Attraction.create(name: "Washington Monument", description: "The Washington Monument is an obelisk within the National Mall in Washington, D.C., built to commemorate George Washington", image: "https://d1dzqwexhp5ztx.cloudfront.net/imageRepo/7/0/113/310/593/S_Washington_Monument_S.jpg", location: "Washington Dc", price: 4.99, category_id: cat3.id )
